...
class CryptoCurrency:
    def __init__(self,root):
        self.root=root
        self.root.title("Crypto Currency Conversion")
        ...
        def clear():
            answer.set("")
            value.set("")
            froms.set("Select Crypto Currency From")
        ...
        def convert():
            try:
                if froms.get()!="Select Crypto Currency From":
...
#===================================================#
        ...
        select_currency_from=['BTC','ETH','LTC','XMR','XRP']
        ...
        select_currency_from_combo.set("Select Crypto Currency From")
        ...
        select_currency_to_combo.set("Select Currency To")
